...
class EnrollsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create enroll" do
    assert_difference('Enroll.count') do
      post enrolls_url, params: { enroll: { device_id: @enroll.device_id, staff_id: @enroll.staff_id } }
    end
  ...
  test "should update enroll" do
    patch enroll_url(@enroll), params: { enroll: { device_id: @enroll.device_id, staff_id: @enroll.staff_id } }
